...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Its hello world hello hello</h1>
                    <p>Bringing you experience of hello hello hello</p>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Its jane insane world hello hello</h1>
                    <p>Be first to purchase the record in lossless quality</p>
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <p>iNsTamanIac niNja</p>
                    <p>Feels like enery surging through your body. Listen some sample and purchase.</p>
